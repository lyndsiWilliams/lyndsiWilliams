...
Skills: React | Redux | Vite | React Context | React Testing Library | React Native | Jest | RESTful API | Javascript | Typescript | HTML | CSS | Emotion |  LESS/SASS | Deployment | Git | GraphQL | NodeJS | Express | SQL | Python | Agile/Scrum methodology
