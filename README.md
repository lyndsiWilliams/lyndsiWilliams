...
Skills: Javascript | Typescript | HTML | CSS | React | NextJS | Vite | Redux | React Context | React Native | React Testing Library | Jest | RESTful API | Emotion | LESS/SASS | GraphQL | NodeJS | Express | SQL | Python | Deployment | Git | Agile/Scrum methodology
